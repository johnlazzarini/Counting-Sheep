...
public class AddNaturalsActivity extends MathActivity implements MathActivityInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final User theUser = new User("Addition", "Natural Numbers", timerLength);
        ...
        createAndActivateTimer(timerLength, contextDisplay, dataDisplay, recipientNameArea,
                inputOutput, progressRoot, sendEmail, submit, AddNaturalsActivity.this, theUser);
    }

    //overloaded methods
    public void addSheep(LinearLayout root, User theUser){
        ImageView newSheepFace = new ImageView(AddNaturalsActivity.this, null);
