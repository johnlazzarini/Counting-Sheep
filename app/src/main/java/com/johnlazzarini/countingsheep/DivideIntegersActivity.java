...
public class DivideIntegersActivity extends MathActivity implements MathActivityInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAndActivateTimer(timerLength, contextDisplay, dataDisplay, recipientNameArea,
                inputOutput, progressRoot, sendEmail, submit, DivideIntegersActivity.this, theUser);
    }

    //overloaded methods
    public void addSheep(LinearLayout root, User theUser){
        ImageView newSheepFace = new ImageView(DivideIntegersActivity.this, null);
