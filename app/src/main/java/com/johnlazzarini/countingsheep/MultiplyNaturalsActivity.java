...
public class MultiplyNaturalsActivity extends MathActivity implements MathActivityInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final User theUser = new User("Multiplication", "Natural Numbers", timerLength);
        ...
        createAndActivateTimer(timerLength, contextDisplay, dataDisplay, recipientNameArea,
                inputOutput, progressRoot, sendEmail, submit, MultiplyNaturalsActivity.this, theUser);
    }

    //overloaded methods
    public void addSheep(LinearLayout root, User theUser){
        ImageView newSheepFace = new ImageView(MultiplyNaturalsActivity.this, null);
